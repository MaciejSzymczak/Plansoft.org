alter table usos_temp modify (from_hour number(2,0));
alter table usos_temp modify (from_min  number(2,0));
alter table usos_temp modify (to_hour  number(2,0));
alter table usos_temp modify (to_min  number(2,0));
alter table usos_temp add (TRM_GRUP_ID number);
alter table usos_temp add (PRAC_ID number);
create index usos_temp1 on usos_temp (TRM_GRUP_ID);
alter table usos_temp add (USOS_OD_DATA date);
alter table usos_temp add (USOS_DO_DATA date);
