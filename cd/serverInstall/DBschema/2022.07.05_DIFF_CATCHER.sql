delete from system_parameters where name='DIFF_END_DATE';
delete from system_parameters where name='DIFF_MODE';
insert into system_parameters (name, value) values ('DIFF_END_DATE', '3000-01-01');
insert into system_parameters (name, value) values ('DIFF_MODE', '');
Commit;

drop table DIFF_CATCHER_HELPER;
