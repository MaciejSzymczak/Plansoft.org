alter table gro_cla add (parent_Id number);
create index gro_cla_parent_Id on gro_cla (parent_Id);

alter table rom_cla add (parent_Id number);
create index rom_cla_parent_Id on rom_cla (parent_Id);

alter table lec_cla add (parent_Id number);
create index lec_cla_parent_Id on lec_cla (parent_Id);

alter table gro_cla_history add (parent_Id number);
