...
----
ALTER TABLE TT_COMBINATIONS MODIFY (INTEGRATION_ID VARCHAR2(80));

ALTER TABLE INT_PLAN ADD (PLAN_ID VARCHAR2(40));
ALTER TABLE TT_INTERFACE ADD (PLAN_ID VARCHAR2(40));
ALTER TABLE TT_COMBINATIONS ADD (PLAN_ID VARCHAR2(40));

create index INT_PLAN_PI on INT_PLAN (PLAN_ID);
create index TT_INTERFACE_PI on TT_INTERFACE (PLAN_ID);
create index TT_COMBINATIONS_PI on TT_COMBINATIONS (PLAN_ID);

alter table int_classes add (PLAN_INTEGRATION_ID2 varchar2(500));
alter table int_classes_diff add (PLAN_INTEGRATION_ID2 varchar2(500));
...
create or replace package integration is 
   ...
   | 2023.12.04 Maciej Szymczak American Systems  
   \-----------------------------------------------------------------------------------------------------------------------------*/ 
