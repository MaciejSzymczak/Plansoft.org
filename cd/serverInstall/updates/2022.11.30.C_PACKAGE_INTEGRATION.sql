drop table int_plan;
  ...
  CREATE TABLE "INT_PLAN" 
   (	"INTEGRATION_ID" VARCHAR2(20 BYTE), 
	...
	"CNT" NUMBER, 
	"ALERTS" VARCHAR2(250 BYTE), 
	"IS_ACTIVE" VARCHAR2(20 BYTE)
   ) TABLESPACE "USERS" ;

drop table BAZUS_SUB_MAP;

  CREATE TABLE "BAZUS_SUB_MAP" 
   (	"SUBJECT_NAME" VARCHAR2(250 BYTE), 
	"FORM_NAME" VARCHAR2(250 BYTE), 
	"SUB_FORM_INTEGRATION_ID" VARCHAR2(20 BYTE), 
	"SUB_INTEGRATION_ID" VARCHAR2(20 BYTE)
   ) TABLESPACE "USERS" ;

  CREATE INDEX "PLANNER"."BAZUS_SUB_MAP1" ON "PLANNER"."BAZUS_SUB_MAP" ("SUB_FORM_INTEGRATION_ID") 
  TABLESPACE "USERS" ;

  CREATE INDEX "PLANNER"."BAZUS_SUB_MAP2" ON "PLANNER"."BAZUS_SUB_MAP" ("SUB_INTEGRATION_ID") 
  TABLESPACE "USERS" ;
...
begin   
    ...
    select value into pperiod_name from system_parameters where name = 'INT_PERIOD_NAME';
    select to_char(date_from,'yyyy-mm-dd'), to_char(date_to,'yyyy-mm-dd'), id into pDate_From, pDate_To, pPER_ID from periods where name=pperiod_name;
    ---  
    -- ******************************************************************
    -- *************recalc_combination122  ******************************
    -- ******************************************************************
