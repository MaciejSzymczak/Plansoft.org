...
begin
  Form1.Memo1.lines.Text := httpPOST('https://soft.home.pl/tools/zipAPI.php','txt=Siala Baba mak nie wiedziala jak&param2=value2','Content-Type: application/x-www-form-urlencoded',80);
...
begin
     Form1.output.lines.Text := httpPOST(url.text,'txt='+URLEncode(input.lines.Text)+'&param2=value2','Content-Type: application/x-www-form-urlencoded',80);
end;
