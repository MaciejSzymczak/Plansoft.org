...
begin
  ...
  dmodule.SQL('begin update resource_categories set name=:name, plural_name=:pl_name, name_accusative=:acc_name, name_genitive=:gen_name where id = :id; commit; end;', 'name='+profileObjectNamePeriod.Text+';pl_name='+profileObjectNamePeriods.Text+';acc_name='+profileObjectNamePeriodacc.Text+';gen_name='+profileObjectNamePeriodgen.Text+';id=-7');
  dmodule.SQL('begin update resource_categories set name=:name, plural_name=:pl_name, name_accusative=:acc_name, name_genitive=:gen_name where id = :id; commit; end;', 'name='+profileObjectNamePlanner.Text+';pl_name='+profileObjectNamePlanners.Text+';acc_name='+profileObjectNamePlanneracc.Text+';gen_name='+profileObjectNamePlannergen.Text+';id=-6');
  dmodule.SQL('begin update resource_categories set name=:name, plural_name=:pl_name, name_accusative=:acc_name, name_genitive=:gen_name where id = :id; commit; end;', 'name='+profileObjectNameG.Text+';pl_name='+profileObjectNameGs.Text+';acc_name='+profileObjectNameGacc.Text+';gen_name='+profileObjectNameGgen.Text+';id=-5');
  dmodule.SQL('begin update resource_categories set name=:name, plural_name=:pl_name, name_accusative=:acc_name, name_genitive=:gen_name where id = :id; commit; end;', 'name='+profileObjectNameL.Text+';pl_name='+profileObjectNameLs.Text+';acc_name='+profileObjectNameLacc.Text+';gen_name='+profileObjectNameLgen.Text+';id=-4');
  dmodule.SQL('begin update resource_categories set name=:name, plural_name=:pl_name, name_accusative=:acc_name, name_genitive=:gen_name where id = :id; commit; end;', 'name='+profileObjectNameC1.Text+';pl_name='+profileObjectNameC1s.Text+';acc_name='+profileObjectNameC1acc.Text+';gen_name='+profileObjectNameC1gen.Text+';id=-3');
  dmodule.SQL('begin update resource_categories set name=:name, plural_name=:pl_name, name_accusative=:acc_name, name_genitive=:gen_name where id = :id; commit; end;', 'name='+profileObjectNameC2.Text+';pl_name='+profileObjectNameC2s.Text+';acc_name='+profileObjectNameC2acc.Text+';gen_name='+profileObjectNameC2gen.Text+';id=-2');
